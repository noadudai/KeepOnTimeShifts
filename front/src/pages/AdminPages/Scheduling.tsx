...
import {
    ...
    ScheduleStatus,
} from '@noadudai/scheduler-backend-client/dist/api';
...
const Scheduling = () => {
    ...
    const scheduleIdForNextWeek = scheduleForNextWeek?.schedule?.id;
        ...
        <div className="flex items-center justify-center gap-4 p-2">
            ...
            {isWeeklyShiftPanelOpen && (
                <WeeklyShiftPanel
                    ...
                    scheduleIdToPublish={
                        scheduleForNextWeek?.schedule?.status === ScheduleStatus.Published
                            ? undefined
                            : (scheduleIdForNextWeek ?? undefined)
                    }
                />
            )}
        </div>
